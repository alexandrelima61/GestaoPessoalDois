...
public class JsfLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
     ...
     *
     * @param useForward true if a forward to the login page should be used.
     * Must be false (the default) if {@code loginFormUrl} is set to an absolute
     * value.
     */
